...
RUN DEBIAN_FRONTEND=noninteractive apt-get -y --force-yes install curl apache2 mysql-client supervisor php5 php7-nightly libapache2-mod-fastcgi php5-fpm apache2-mpm-event php5-gd php5-mysql php-pear php5-curl php5-dev openssh-client make libpcre3-dev software-properties-common
